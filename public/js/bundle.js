...
var hideAlert = function hideAlert() {
  var elt = document.querySelector('.alert');
...
exports.forgotpass = exports.resetPass = exports.signup = exports.logout = exports.login = void 0;
        ...
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'logged out successfuly'); //force reload from the server
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'account created  successfuly'); //force reload from the server
...
var resetPass = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(password, passwordConfirm) {
    var token, res;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'password rested  successfuly'); //force reload from the server
  ...
  return function resetPass(_x7, _x8) {
...
var forgotpass = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'email sent successfuly');
            }
  ...
  return function forgotpass(_x9) {
...
exports.updateUserPassword = exports.updateUserinfo = void 0;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'password updated !'); //location.reload();
            }
...
var stripe = Stripe('pk_test_QOBsxJ8WjoP8eFsmVb8q0EJC00UIJJ1H0L');
...
var fromUpdateInfo = document.querySelector('.form-user-data');
var fromUpdatePassword = document.querySelector('.form-user-settings');
var btnlogout = document.querySelector('.nav__el--logout');
var fromReset = document.getElementById('form-reset');
var fromForgot = document.getElementById('form-forgot');
...
if (fromUpdateInfo) {
  fromUpdateInfo.addEventListener('submit', function (e) {
    e.preventDefault();
    var form = new FormData();
    form.append('name', document.getElementById('name').value);
    form.append('email', document.getElementById('email').value); //files is an array

    form.append('photo', document.getElementById('photo').files[0]);
    /* const email = document.getElementById('email').value;
    const name = document.getElementById('name').value; */

    (0, _updateSettings.updateUserinfo)(form);
  });
}

if (fromUpdatePassword) {
  fromUpdatePassword.addEventListener('submit', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 7;
              return (0, _updateSettings.updateUserPassword)(currentPassword, password, passwordConfirm);
...
if (fromReset) {
  fromReset.addEventListener('submit', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              passwordConfirm = document.getElementById('passwordConfirm').value;
              _context3.next = 5;
              return (0, _login.resetPass)(password, passwordConfirm);
...
if (fromForgot) {
  fromForgot.addEventListener('submit', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              email = document.getElementById('email').value;
              _context4.next = 5;
              return (0, _login.forgotpass)(email);
